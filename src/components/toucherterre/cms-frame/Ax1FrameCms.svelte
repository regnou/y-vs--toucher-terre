...
<script lang="ts">
	...
	onMount(() => {
		...
		axlog({ data: $AX_STORE__CONTENT, db: $AX_STORE__CONTENT_DB }, $page.url.pathname, 'wc -- (((((( FRAME-cms ))))))', false, 'MOUNT', true);
	});
	//
	$: {
		// <!-- .................. -->
	...
	import { AX_CONST__FRAME__isDebugBorder, AX_CONST__FRAME__isDebugResolutionmobile } from 'app/0-config/frame/AX_CONST__FRAME__debug';
	...
	import AxDrawerCms from './Ax3DrawerCms.svelte';
	import AxHeaderCms from './Ax2HeaderCms.svelte';
