...
<script lang="ts">
	...
	onMount(() => {
		axlog({ data: $AX_STORE__CONTENT, db: $AX_STORE__CONTENT_DB }, $page.url.pathname, 'wc -- (((((( FRAME-app ))))))', false, 'MOUNT', true);
	});
	...
	import { AX_CONST__FRAME__isDebugBg, AX_CONST__FRAME__isDebugBorder, AX_CONST__FRAME__isDebugResolutionmobile } from 'app/0-config/frame/AX_CONST__FRAME__debug';
	...
	import { AX_CONST__FRAME_URL__home } from 'app/0-config/frame/AX_CONST__FRAME__urls';
