<script lang="ts">
	...
	import { DATAJSON__HEADERMENU__APP } from '@app/domain/DATA/MENUS/DATAJSON__HeaderMenuApp.json';
...
<!-- DRAWER -->
<!--  -->
<Drawer bind:this={drawer} bind:variant={dynVariant} bind:open id="drawer-app" class="fixed">
	<Header>
