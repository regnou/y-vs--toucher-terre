		...
		{#if $STORE_LADEMARCHE && $STORE_LADEMARCHE.length}
			<div class="grid h-full w-full grid-cols-3 gap-10">
				...
				<div class=" mr-10">
					...
					<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[0].inputValue} />
					<Separator />
					<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[1].inputValue} />
					<Separator />
					<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[2].inputValue} />
					<Separator />
					<img
				...
				<div class="">
					...
					<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[3].inputValue} />
					<Separator />
					<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[4].inputValue} />
					<Separator />
					<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[5].inputValue} />
					<Separator />
					<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[6].inputValue} />
					<Separator />
				</div>
				...
				<div class=" ml-20">
					...
					<div class="m-5 rounded-md bg-white/30 p-2">
						<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[7].inputValue} />
						<Separator />
						<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[8].inputValue} />
						<Separator />
						<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[9].inputValue} />
						<Separator />
						<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[10].inputValue} />
						<Separator />
						<Paragraph text={$STORE_LADEMARCHE[0].posts[0].inputValues[11].inputValue} />
					</div>
					<Separator />
					<img
