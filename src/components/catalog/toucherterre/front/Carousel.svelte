<!-- https://github.com/vercel/sveltekit-commerce/blob/main/src/components/Carousel.svelte -->
<script lang="ts">
...
<div id="catalog-carousel" class="slider relative w-full overflow-scroll bg-light">
	<div class="slide-track flex">
		{#each items as item (item.node.id)}
			<a
				data-sveltekit-prefetch
				href={`${base}/product/${item.node.handle}`}
