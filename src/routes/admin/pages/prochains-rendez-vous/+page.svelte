<script lang="ts">
	...
	import { DATAJSON__INJECT_PROCHAINSRDV } from '@app/domain/DATA/DB-INJECT/DATAJSON__INJECT_ProchainsRdv.json';
	import { TABLE_PROCHAINSRDV } from '@app/z-entities/COLLECTIONS';
	import { DATAJSON__ADD_PROCHAINSRDV } from '@app/domain/DATA/DB-ADD/DATAJSON__ADD_ProchainsRdv.json';
</script>
...
<Layoutadminapp>
	...
	<div slot="admin">
		<GenericAdmin
			...
			GENERIC_ADD={DATAJSON__ADD_PROCHAINSRDV}
