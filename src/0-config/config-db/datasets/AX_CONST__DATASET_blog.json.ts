export const AX_CONST__DATASET__blog: I_DTO__post[] = [
	{
	...
	// --------------------- 2
	{
		...
		body: {
			...
			tag: 'area',
			label: 'corps',
			value: 'Structure de charpente autoportante le plus souvent en rond, qui ne nécessite aucun pilier central. Elle permet de créer des toits, des ponts et toutes sortes de structures'
		}
	},
	// --------------------- 3
	{
		...
		body: {
			...
			tag: 'area',
			label: 'corps',
			value: 'Économe en bois, ce tag de poêle auto-construit est basé sur la technique du «Rocket Stove». La chaleur est accumulée dans la masse et ensuite diffusée par rayonnement. Ces poêles font partie des appareils de chauffage au bois les plus perinputValuesants'
		}
	},
	// --------------------- 4
	{
		...
		body: {
			...
			tag: 'area',
			label: 'corps',
			value: 'Biodégradable. Conçu à partir de matériaux naturels, à même de se décomposer naturellement une fois détruit (kerterre, love-shack, maison terre …). Tous ces habitats ont en commun le fait de permettre au terrain de revenir dans son état initial lorsqu’ils sont démontés ou compostés.'
		}
	},
	// --------------------- 5
	{
		...
		body: {
			...
			tag: 'area',
			label: 'corps',
			value: 'Posés sur supports variés (paille, toile de jutte, pierres, parpaings ...); Fabriqués à partir de terre argileuse et au mieux, à partir de matériaux trouvés sur chantier ou alentour (paille, sciure, bouse, foin, tonte etc ...)'
		}
	}
	// ,
	// x3 slideshows
