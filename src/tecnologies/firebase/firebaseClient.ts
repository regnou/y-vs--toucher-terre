// @@@ FIREBASE-CONFIG
import { AX_CONST__TEC_firebase } from '../../domain/DATACONST/config-tecnologies/AX_CONST__TEC_firebase.json';
// @@@ FIREBASE CLIENT
...
export function getFirebase() {
	...
	function initializeServices() {
		...
		const app = initializeApp(AX_CONST__TEC_firebase.firebase);
